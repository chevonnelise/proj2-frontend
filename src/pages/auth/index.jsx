...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try{
        const user = await axios.post("https://3000-chevonnelis-proj2backen-lqv6rdz4jy0.ws-us110.gitpod.io/api/users/register", {
            username,
            email,
            password
        })
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try{
        const result = await axios.post("https://3000-chevonnelis-proj2backen-lqv6rdz4jy0.ws-us110.gitpod.io/api/users/login", {
            username,
            email,
            password
        })
